if (typeof component_classes['data_model_request_state'] === "undefined") {
	class data_model_request_state extends DivbloxDomBaseComponent {
		constructor(inputs,supports_native,requires_native) {
			super(inputs,supports_native,requires_native);
			// Sub component config start
			this.sub_component_definitions = [
				{"component_load_path":"data_model/request_state_data_series","parent_element":"data_series","arguments":{"uid":this.getUid()+"_request_state_data_series_component"}},
				{"component_load_path":"data_model/request_state_update","parent_element":"data_update","arguments":{"uid":this.getUid()+"_request_state_update_component"}},
				{"component_load_path":"data_model/request_state_create","parent_element":"data_create","arguments":{"uid":this.getUid()+"_request_state_create_component"}}];
		...
		eventTriggered(event_name,parameters_obj) {
			...
			switch(event_name) {
				case 'request_state_create_clicked':this.toggleSubView("data_create_wrapper");
					getRegisteredComponent(this.getUid()+"_request_state_create_component").reset();
					break;
				case 'request_status_clicked':this.toggleSubView("data_update_wrapper");
					getRegisteredComponent(this.getUid()+"_request_state_update_component").reset(parameters_obj.id);
					break;
				case 'request_status_created':
				case 'request_status_deleted':
				case 'request_status_updated':
				case 'request_state_back_clicked':this.toggleSubView("data_series_wrapper");
					getRegisteredComponent(this.getUid()+"_request_state_data_series_component").reset();
					break;
				default:
		...
		registerDomEvents() {
			getComponentElementById(this,"button_create").on("click", function() {
				pageEventTriggered("request_state_create_clicked",{});
			});
			getComponentElementById(this,"button_create_back").on("click", function() {
				pageEventTriggered("request_state_back_clicked",{});
			});
	...
	component_classes['data_model_request_state'] = data_model_request_state;
}

if (typeof(on_data_model_request_state_ready) === "undefined") {
	function on_data_model_request_state_ready(load_arguments) {
		...
		this.reset = function(inputs) {
			dxLog("Reset for request_state not implemented");
		...
		// Sub component config start
		this.sub_components =
			{"0":{"component_load_path":"data_model/request_state_data_series","parent_element":"data_series","loading_arguments":{"uid":this.getUid()+"_request_state_data_series_component"}},
			"1":{"component_load_path":"data_model/request_state_update","parent_element":"data_update","loading_arguments":{"uid":this.getUid()+"_request_state_update_component"}},
			"2":{"component_load_path":"data_model/request_state_create","parent_element":"data_create","loading_arguments":{"uid":this.getUid()+"_request_state_create_component"}}};
		// Sub component config end
