if (typeof component_classes['data_model_my_request_list'] === "undefined") {
	class data_model_my_request_list extends DivbloxDomBaseComponent {
		...
		deleteSelected() {
			dxRequestInternal(getComponentControllerPath(this),
				...
				function(data_obj) {
					...
					this.current_page = 1;
					this.loadPage();
					pageEventTriggered("stock_photo_request_selection_deleted",{});
				}.bind(this),
				function(data_obj) {
		...
		loadPage() {
			let uid = this.getUid();
			let search_text = getComponentElementById(this,"DataTableSearchInput").val();
			getComponentElementById(this,"DataTableBody").html('<tr id="'+uid+'_DataTableLoading"><td colspan="4"' +
	...
	component_classes['data_model_my_request_list'] = data_model_my_request_list;
}